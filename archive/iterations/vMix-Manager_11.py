...
class CategoryExportWidget(QWidget):
    def __init__(self, parent=None):
        ...
        sub.setStyleSheet(f"color:{C['dim']}; font-family:Cambria; font-size:12px; font-style:italic;")
...
class FolderImportWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.btn_import = QPushButton("Start Bulk Import  ▶")
        self.btn_import.setFont(F(16, bold=True)); self.btn_import.setFixedHeight(56)
...
class MainWindow(QMainWindow):
    ...
    def _build_toolbar(self):
        ...
        self.file_lbl.setFont(F(15, bold=True))
        self.file_lbl.setStyleSheet(f"color:{C['text']};background:transparent;")
    ...
    def _build_cat_panel(self) -> QWidget:
        ...
        self.cat_stat = QLabel("  Right-click to add / rename / delete")
